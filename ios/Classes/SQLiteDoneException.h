...
#pragma push_macro("INCLUDE_ALL_SQLiteDoneException")
#ifdef RESTRICT_SQLiteDoneException
#define INCLUDE_ALL_SQLiteDoneException 0
#else
#define INCLUDE_ALL_SQLiteDoneException 1
#endif
#undef RESTRICT_SQLiteDoneException

#if !defined (ComYahooAndroidSqliteSQLiteDoneException_) && (INCLUDE_ALL_SQLiteDoneException || defined(INCLUDE_ComYahooAndroidSqliteSQLiteDoneException))
...
#pragma pop_macro("INCLUDE_ALL_SQLiteDoneException")
